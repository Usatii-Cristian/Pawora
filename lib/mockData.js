...
export const PRODUCTS = [
  ...
  // ── Echipament acvariu: filtre, încălzitoare, plante artificiale ──
  {
    id: 'prod-51',
    name: 'Filtru extern Eheim Classic 250',
    description:
      'Filtru extern pentru acvarii de până la 250 litri. Filtrare mecanică, biologică și chimică în trei etape. Funcționare extrem de silențioasă și consum redus de energie. Include materiale filtrante.',
    price: 1290,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-52',
    name: 'Filtru intern AQUAEL Fan 2 Plus',
    description:
      'Filtru intern compact pentru acvarii de 60–150 litri. Cap de pompă reglabil, burete filtrant ușor de curățat și aerator integrat. Montaj simplu pe peretele acvariului cu ventuze.',
    price: 320,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-53',
    name: 'Încălzitor acvariu AQUAEL 100W',
    description:
      'Încălzitor cu termostat reglabil pentru acvarii de până la 100 litri. Menține o temperatură constantă a apei între 20–34°C. Sticlă termorezistentă și protecție la supraîncălzire.',
    price: 240,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-54',
    name: 'Încălzitor Tetra HT 75W cu termometru',
    description:
      'Încălzitor de precizie cu indicator LED și termometru inclus. Ideal pentru acvarii de 60–100 litri. Se oprește automat la atingerea temperaturii setate. Instalare verticală sau orizontală.',
    price: 285,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-55',
    name: 'Pompă de aer Tetra APS 100',
    description:
      'Pompă de aer silențioasă pentru acvarii de până la 100 litri. Oxigenare eficientă, vibrații minime și design compact. Include difuzor de aer și furtun. Esențială pentru sănătatea peștilor.',
    price: 199,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-56',
    name: 'Set plante artificiale acvariu (6 buc)',
    description:
      'Set de 6 plante artificiale din plastic moale, sigure pentru pești. Imită vegetația naturală a acvariului, oferind ascunzișuri și un aspect viu. Bază ponderată care nu plutește. Ușor de curățat.',
    price: 145,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-57',
    name: 'Decor alge artificiale verzi 30cm',
    description:
      'Plantă-algă artificială înaltă de 30 cm pentru fundalul acvariului. Material textil fin care se mișcă natural în curent. Culoare verde realistă, nu decolorează. Bază din ceramică stabilă.',
    price: 89,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-58',
    name: 'Substrat pietriș natural acvariu 5kg',
    description:
      'Pietriș natural fin spălat, granulație 2–4 mm, pentru acvarii de apă dulce. Nu modifică parametrii apei. Susține bacteriile benefice și sistemul radicular al plantelor. Sac de 5 kg.',
    price: 120,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-59',
    name: 'Termometru digital acvariu',
    description:
      'Termometru digital cu afișaj LCD și senzor submersibil. Precizie de ±0.1°C, citire rapidă. Se fixează cu ventuză pe peretele acvariului. Baterie inclusă. Monitorizare ușoară a temperaturii.',
    price: 65,
    image: '',
    category: 'fish',
    subcategory: 'accessories',
  ...
  // ── Jucării suplimentare ──
  {
    id: 'prod-60',
    name: 'Minge interactivă pisici cu clopoțel',
    description:
      'Minge interactivă cu clopoțel și pene atașate care stimulează instinctul de vânătoare al pisicii. Material ușor și sigur, perfectă pentru joacă activă. Ține pisica ocupată ore întregi.',
    price: 49,
    image: '',
    category: 'cats',
    subcategory: 'toys',
  ...
  {
    id: 'prod-61',
    name: 'Tunel de joacă pliabil pisici',
    description:
      'Tunel pliabil cu 3 ieșiri pentru pisici jucăușe. Material fâșâitor care atrage atenția, cu o minge atârnată la interior. Se pliază pentru depozitare ușoară. Distracție și exercițiu garantat.',
    price: 175,
    image: '',
    category: 'cats',
    subcategory: 'toys',
  ...
  {
    id: 'prod-62',
    name: 'Frânghie de bumbac pentru câini',
    description:
      'Jucărie din frânghie de bumbac natural pentru ros și tras. Curăță dinții și masează gingiile câinelui în timpul jocului. Rezistentă la mestecat intens. Ideală pentru jocuri de tip „tug-of-war".',
    price: 79,
    image: '',
    category: 'dogs',
    subcategory: 'toys',
  ...
  {
    id: 'prod-63',
    name: 'Set 3 mingi de tenis pentru câini',
    description:
      'Set de 3 mingi rezistente, special concepute pentru câini. Dimensiune ideală pentru aport, plutesc pe apă și nu deteriorează dinții. Culori vii ușor de găsit în iarbă.',
    price: 55,
    image: '',
    category: 'dogs',
    subcategory: 'toys',
  ...
  {
    id: 'prod-64',
    name: 'Bol dublu inox cu suport',
    description:
      'Castron dublu din oțel inoxidabil pe suport antiderapant. Ideal pentru hrană și apă. Inoxul este igienic, ușor de spălat și rezistent. Potrivit pentru câini și pisici de talie medie.',
    price: 165,
    image: '',
    category: 'dogs',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-65',
    name: 'Litieră închisă cu filtru pentru pisici',
    description:
      'Litieră închisă cu ușiță batantă și filtru de carbon împotriva mirosurilor. Oferă intimitate pisicii și menține nisipul în interior. Mâner pentru transport și capac detașabil pentru curățare ușoară.',
    price: 320,
    image: '',
    category: 'cats',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-66',
    name: 'Perie de îngrijire blană (deshedding)',
    description:
      'Perie profesională pentru îndepărtarea părului mort și a nodurilor. Reduce năpârlirea cu până la 90%. Buton de auto-curățare. Mâner ergonomic antiderapant. Pentru câini și pisici cu păr scurt sau lung.',
    price: 135,
    image: '',
    category: 'cats',
    subcategory: 'accessories',
  ...
  {
    id: 'prod-67',
    name: 'Cușcă transport animale mici',
    description:
      'Cușcă de transport ventilată pentru hamsteri, cobai și iepuri mici. Mâner robust, închidere sigură și fund detașabil pentru curățare. Aerisire optimă pe toate laturile. Ușoară și rezistentă.',
    price: 210,
    image: '',
    category: 'small-animals',
    subcategory: 'accessories',
